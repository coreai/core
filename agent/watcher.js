// compare this dataset vs the average of all data

// see if there is a signficant difference between the datasets

// Realtime Watching

// https://github.com/sergibondarenko/anomaly-finder

// Use the Anomaly Finder to set the rewards for the Q Agent
// Benchmark which does better...
...
for (let i = 0; i < valuesToCheck.length; i++) {
  ...
  console.log(`${valuesToCheck[i]} is strange: ${isAnomaly}`); 
}
