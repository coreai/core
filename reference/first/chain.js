...
var readLedger = (ledger) => JSON.parse (fs.readFileSync(ledger));
var writeLedger = (ledger, block) => fs.writeFileSync(ledger, JSON.stringify(block), 'utf-8');
var appendLedger = (ledger, block) => fs.appendFileSync(ledger, JSON.stringify(block));
...
var startBlockchain = () => {
    if (fs.existsSync(ledger)) {
        ...
        writeLedger(ledger, [getGenesisBlock()]);
    }
}
startBlockchain();
