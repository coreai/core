...
const {isChainValid} = require('../blockchain/chain')
const {checkBlock, makeGenesisBlock} = require('../blockchain/block')
const {checkTransaction, buildTransaction} = require('../blockchain/transaction')
const {generateKeyPair} = require('../blockchain/wallet')


const store = {

  //ledger = "./blockchain.json",
 
  difficulty: config.difficulty ? 100000000 : 10000 * 1, // The less value the bigger difficulty
